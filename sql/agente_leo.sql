-- =====================================================
-- AGENTE LEO - Schema (versão sem depender de has_role)
...
INSERT INTO public.leo_api_keys (key_name, description) VALUES
  ...
  ('PRIMESYNC_TOKEN',    'Bearer token da API PrimeSync para envio WhatsApp'),
...
-- =====================================================
-- RLS (sem usar has_role - consulta direta a user_roles)
-- =====================================================
